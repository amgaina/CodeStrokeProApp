...
import ULM_PHARMACY_LOGO from "@/assets/ULM_pharmacy_logo.png";
            ...
            <div className="container mx-auto px-4 py-8 max-w-7xl">
                ...
                <div className="mb-8 text-center">
                    ...
                    <p className="text-deep-charcoal/70 text-lg max-w-3xl mx-auto">
                        ...
                        stroke care protocols and resources.
                    </p>
                </div>
                    ...
                    <Card className="mb-6 md:mb-8 clarity-shadow border border-harbor-gray bg-white">
                        ...
                        <CardContent className="p-4 md:p-8 space-y-4 md:space-y-6">
                            ...
                            <p className="text-gray-600 mb-6">
                                ...
                                the health, wellness, and quality of life in
                                northeast Louisiana. Founded in 2006, the Living
                                Well Foundation serves the residents of
                                Caldwell, Franklin, Jackson, Lincoln, Morehouse,
                                Ouachita, Richland, and Union Parishes. For more
                                ...
                                . The Living Well Foundation's commitment to
                                improving healthcare accessibility helps us
                                provide essential stroke care resources to those
                                who need them most.
                            </p>

                            <p className="text-gray-600">
                                This project was created by faculty members at
                                University of Louisiana at Monroe College of
                                Pharmacy and also supports the mission of the
                                ULM College of Pharmacy: Enhancing the health
                                and environment of the communities we serve.
                            </p>
                            <p className="mt-4 text-gray-600 text-center">
                                ...
                                <span className="italic">
                                    "Empowering Rural Healthcare Providers.
                                    Enhancing Stroke Care. Saving Lives."
                                </span>
                            </p>
                        </CardContent>
                    </Card>
