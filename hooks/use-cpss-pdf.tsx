...
export default function useCpssPdf({
    ...
    const criteriaDescriptions = useMemo(
        () => ({
            ...
            armDrift:
                "Ask patient to close eyes and hold both arms out with palms up for 10 seconds.",
        ...
        try {
            ...
            if (isComplete) {
                if (hasPositiveSign) {
                    ...
                    doc.setTextColor(100, 100, 100);
                    doc.text(
                        "(~72% probability if any 1 of 3 signs present)",
                        20,
                        65
                    );
                } else {
            ...
            if (isComplete) {
                if (hasPositiveSign) {
                    ...
                    doc.setFontSize(11);
                    doc.text(
                        "Approximately 72% probability with any 1 of 3 signs present",
                        20,
                        finalY + 14
                    );
                ...
                doc.setTextColor(100, 100, 100);
                doc.text(
                    "Assessment incomplete. Please complete all three questions.",
                    20,
                    finalY + 7
                );
                finalY += 14;
            ...
            doc.setProperties({
                title: "Cincinnati Prehospital Stroke Scale (CPSS) Assessment",
                subject: "CPSS assessment results and details",
                author: "CodeStrokePro",
                keywords:
                    "CPSS, stroke, assessment, Cincinnati, prehospital, screening",
