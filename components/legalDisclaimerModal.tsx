        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
            ...
            <div className="relative mx-4 flex max-h-[90vh] w-full max-w-2xl flex-col rounded-lg bg-white p-6 shadow-xl">
                ...
                <div className="flex-1 overflow-y-auto pr-2 text-deep-charcoal/80">
                    <p className="mb-3">
                        1. This application is provided as a clinical support and educational tool
                        only. It is designed to assist qualified healthcare professionals in
                        managing time-sensitive decisions in acute stroke care but is not a
                        substitute for independent clinical judgment, institutional protocols,
                    ...
                    <ul className="mb-3 list-inside list-disc space-y-2 pl-4">
                        <li>
                            The app does not make treatment decisions and is not a source of
                            medical advice.
                        </li>
                        <li>
                            The app provides guidance only, based on user-input data and current
                            evidence or clinical standards as of the noted date.
                        </li>
                        <li>
                            Ultimate responsibility for patient care remains solely with the
                            treating provider(s).
                        </li>
                        <li>
                            With the appropriate disclaimers in place, the liability of the
                            developers and affiliated institutions is considered to be very low.
                            The developers and institutions assume no liability for any direct or
                            indirect damages, injuries, or outcomes resulting from use or
